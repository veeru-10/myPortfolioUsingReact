    ...
    <>
      <section className="relative max-w-5xl mx-4 lg:mx-auto my-40">
        ...
        <div className="flex items-center justify-center">
          <a href="https://github.com/veeru-10?tab=repositories" target="_blank" className="mt-20 text-sm sm:text-base text-center bg-black text-white hover:bg-black/60 dark:bg-white dark:hover:bg-white/60 dark:text-black px-4 py-3 rounded flex gap-x-2 items-center justify-center transition-colors duration-300">View More<span><CgMoreVertical /></span></a>
        </div>
      </section>
    </>
  )
