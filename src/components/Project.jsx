...
const Project = ({ info }) => {
  ...
  return (
    <>
      <section className="relative overflow-hidden rounded-xl shadow-md shadow-slate-800/80 cursor-pointer border border-white transition-all hover:transform hover:-translate-y-2 duration-300 flex flex-col h-full">
        ...
        <div className="flex flex-col flex-1 justify-between items-start space-y-4 my-6 mx-2 group">
        ...
        {/* urls */}
        <div className="flex gap-x-4 pe-8 pb-8 ml-auto">
