    ...
    <>
      <section className="relative max-w-5xl mt-20 mb-40 mx-4 lg:mx-auto">
        <div className="translate-y-3.5 lg:translate-y-6 z-0">
          <h1 id="education" className="text-5xl sm:text-6xl lg:text-8xl uppercase font-black tracking-tight bg-gradient-to-b from-black to-white/95 dark:bg-gradient-to-b dark:from-white dark:via-white/50 dark:to-black bg-clip-text text-transparent leading-none text-center">Education</h1>
        </div>
